...

{
	...
	GeometryGenerator::MeshData box = geoGen.CreateBox(2.0f, 1.0f, 1.0f, 0);
	...
	GeometryGenerator::MeshData geoSphere = geoGen.CreateGeosphere(4.0f, 20);
...
// This builds the Rendered Items
...

{
	...
	//geoSphereRitem->World = MathHelper::Identity4x4();
	XMStoreFloat4x4(&geoSphereRitem->World, XMMatrixScaling(1.0f, 1.0f, 1.0f) * XMMatrixTranslation(0.0f, 0.0f, 0.0f));
