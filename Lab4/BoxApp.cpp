...
bool BoxApp::Initialize()
{
	...
	XMVECTOR goesintocolor = XMVectorSet(1.0f, 1.0f, 1.0f, 1.0f);

	XMCOLOR color = XMCOLOR(XMVectorGetX(goesintocolor), XMVectorGetY(goesintocolor), XMVectorGetZ(goesintocolor), XMVectorGetW(goesintocolor));
	std::cout << color;
	return true;
}
...
void BoxApp::Update(const GameTimer& gt)
{
	...
	world = XMMatrixRotationY((-XM_PI + mTheta2) / 6.0f);
